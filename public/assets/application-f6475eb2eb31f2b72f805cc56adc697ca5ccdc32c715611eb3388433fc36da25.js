...
(function() {
  window.SocialShareButton = {
    ...
    share: function(el) {
      var $parent, appkey, desc, get_tumblr_extra, img, site, title, tumblr_params, url, via, via_str;
      site = $(el).data('site');
...
$(document).ready(function() {
  $("#burger-nav").on("click", function() {
    $("#main_navigation nav ul").toggleClass("open");
  });
});
/*!
